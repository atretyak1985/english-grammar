...
export const meta: TopicMeta = {
  ...
  /*
    Пастка теми — перша помилка з розділу «Типові помилки»: після `did`
    минулий час уже позначено, тому дієслово лишається в базовій формі.
    Українською минулий час завжди сидить у самому дієслові, тому рука
    ставить його двічі.
  */
  trap: {
    quote: 'Did you sent the invoice?',
    body: 'did уже несе минулий час, тому дієслово лишається в базовій формі → Did you send.',
    strong: 'did',
  },
  words: [
    'deploy',
