...
export const meta: TopicMeta = {
  ...
  /*
    Пастка теми — перша помилка з розділу «Типові помилки»: will на все.
    Українська має один майбутній час, тому рука тягнеться до одного
    англійського відповідника, і домовленість звучить як щойно вигадана.
  */
  trap: {
    quote: 'I will meet them on Thursday.',
    body: 'Зустріч уже в календарі — це домовленість, а не рішення в мить розмови: I am meeting them on Thursday.',
    strong: 'домовленість',
  },
  words: [
    'rollout',
