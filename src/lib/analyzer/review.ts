 ...
 *
 * 5 — кешовані рядки означають інше: не «що модель побачила в тексті», а
 * «розмітка двигуна, злита з вердиктами моделі на хитких збігах». Старі рядки
 * формату 4 цим бампом знеструмлені навмисно.
 */
