...
describe('findMatches — інверсія в питаннях і після nor', () => {
  ...
  it('самостійне had після займенника не стає перфектом', () => {
    // Раніше «had it» позначалось Past Perfect. Тепер локальний шар мовчить:
    // Past Simple тут назвати нема з чого — have не входить у таблицю
    // неправильних дієслів, і самотнє had дістає розмітку від моделі.
    expect(matches('She had it in her pocket.')).toEqual([]);
  });
