 ...
 * інцидент із «Минулих часів» і ранковий апдейт із «Теперішніх». Разом вони
 * дають усі шість конструкцій, тому людина, яка відкрила аналізатор уперше,
 * бачить кожен перемикач у дії, а не три з семи.
 */
