  ...
  return (
    <div className="grid grid-cols-[repeat(auto-fill,minmax(300px,1fr))] gap-4">
      {topic.sections.map((section) => {
        ...
        // Хвилини жили у змісті-сайдбарі; після його прибирання картка —
        // єдине місце, де видно ціну розділу до того, як його відкрито.
        const minutes = sectionMinutes(topic.slug, section.slug);
